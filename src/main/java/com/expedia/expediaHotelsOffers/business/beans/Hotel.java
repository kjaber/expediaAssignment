...
public class Hotel {
	...
	public String toString() {
		return "{ Offer Date Range=" + getOfferDateRange() + ", Destination = " + getDestination() + ", Hotel Info ="
				+ getHotelInfo() + ", Hotel Urgency Info= " + getHotelUrgencyInfo() + ", Hotel Pricing Info= "
				+ getHotelPricingInfo() + ", Hotel Urls" + getHotelUrls() + "}";
	}
