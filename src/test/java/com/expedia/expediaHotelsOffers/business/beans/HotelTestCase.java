...
public class HotelTestCase extends TestCase {
	@Override
	...
	public void testSettersAndGetters(){
		...
		assertNotNull(hotel.getDestination());
		assertNotNull(hotel.getHotelInfo());
		assertNotNull(hotel.getHotelPricingInfo());
		assertNotNull(hotel.getHotelUrgencyInfo());
		assertNotNull(hotel.getHotelUrls());
		assertNotNull(hotel.getOfferDateRange());
	}
